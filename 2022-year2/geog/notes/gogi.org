...
2. *sg*
	 + bus
		 - 2012: govt. partner with bus ops. to inc. cap. & freq. of buses (bus service enhancement programme)
...
***** adv.
+ higher $ discourage driving during p.h. \rightarrow drivers use alternative tpt. (public bus/train)
***** dis.
+ drivers avoid erp \rightarrow traffic diverted to other roads \rightarrow congestion on other roads
***** eg.
1. *singapore*
	 + erp (electronic rd. pricing)
	 + 72 erp gantries set up (2012)
		 - located in more-cong. areas
	 + cashcards inserted into in-vehicle units (ius)
	 + each time a vehicle passes through an erp gantry, an amt. is deducted from its cashcard via short-range radio comm.
	 + success
		 - 15% reduction in trf. vol. on the rd. during peak hr.
		 - avg. expressway speeds: 35 km/h \rightarrow 55 km/h
		 - trf. reduced by 16% within erp zones
		 - trf. vol. in cbd during peak hr. remains relatively stable, despite inc. car ownership over the years
2. *stockholm, sweden*
	 + stockholm congestion tax applies to veh. leaving/entering the cbd (2007)
	 + a bill is sent to the veh. to inform driver of the amt. to pay
	 + traffic vol. fell by 24% during p.h. (cong. charge secretariat, stockholm)
**** increase parking fees
***** exp.
+ inc. driving $, esp. to and from cbd
+ encourage pub. tpt.
+ ppl seek alt. means of tpt. such as pub. tpt. & carpooling
	- carpooling: grp. of ppl. travelling tgt. in the same car & sharing the $
		+ save $ on fuel, parking, cong.
		+ reduces no. of veh. on road
***** adv.
+ high parking $ add to the $ of owning & using cars, discouraging private car ownership
***** dis.
+ drivers may resort to illegal parking \rightarrow block traffic / pose a danger to other drivers
***** eg.
+ *shanghai, china*
...
+ target:
	- keep no. of reg. cars in central shanghai below 2.5m
		+ current: over 2.1m (1.8m are private veh.)
**** enhanced traffic monitoring
***** exp.
+ traffic monitoring can alert drivers of trf-cong. \rightarrow they can avoid travelling on the road
***** adv.
...
1. emas (expressway advisory & monitoring system)
	 + vehicle breakdown / accident \rightarrow live info made avail. to drivers on the roads \rightarrow drivers can opt to take alt. routes
2. glide (green link determining)
	 + computerised trf. light signalling
		 - detects vehicles, pedestrians, maj. rd. jn. \rightarrow adj. the green time accordingly
		 - when more vehicles detected, trf. signal remains green \rightarrow allow veh. to drive through the trf. jn.
		 - trf. signals at nearby jn. are coordinated at the start of their green times \rightarrow drivers can catch the 'green wave' \rightarrow travel from one jn. to the next w/o stop
*** other measures
**** telecommuting
***** def. and exp.
+ /telecommuting/: work arrangemt. where employees wfh or @ a loc. near home
	- do not have to travel to office
...
+ $\therefore$ eliminates need for ppl. to commute to/from workplaces \rightarrow reducing no. of veh. on the road \rightarrow reduces trf-cong.
***** adv.
+ do not need to travel out of their residential areas to go to work
	 - reduces no. of drivers & pub. tpt. passengers during p.h.
***** dis.
+ when millions of ppl. change their work arrangment, local servers may go down and cease to function temporarily \rightarrow more inconv.
**** cycling
***** exp.
...
***** dis.
+ cycling lanes v. near to motor veh. on the road \rightarrow dangerous for cyclists
+ layout, trf., topography \rightarrow may be unsuitable for cycling
***** eg.
+ *copenhagen, denmark*
+ govt. built ntwk. of wide cycling lanes, covering a large part of the city
	- v. conv. for ppl. to travel from place - place
+ numerous bicycle parking lots for cyclists
+ cycling now an impt. means of tpt.
	- 52% ppl. in the city commute by bicycle to wk. / sch. (2013, city of copenhagen)
